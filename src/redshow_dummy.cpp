...
[[gnu::noinline]]
redshow_result_t redshow_data_type_config_dummy(redshow_data_type_t data_type) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_data_type_get_dummy(redshow_data_type_t *data_type) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_pc_views_get_dummy(uint32_t *views) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_mem_views_get_dummy(uint32_t *views) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_approx_level_config_dummy(redshow_approx_level_t level) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_approx_get_dummy(int *degree_f32, int *degree_f64) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
...
[[gnu::noinline]]
redshow_result_t redshow_cubin_unregister_dummy(uint32_t cubin_id, uint32_t mod_id) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
...
[[gnu::noinline]]
redshow_result_t redshow_log_data_callback_register_dummy(redshow_log_data_callback_func func) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
...
redshow_result_t redshow_kernel_end_dummy(uint32_t cpu_thread, int32_t kernel_id,
                                                                    uint64_t host_op_id) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_analysis_begin_dummy() { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_analysis_end_dummy() { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_flush_thread_dummy(uint32_t cpu_thread) { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_flush_dummy() { return REDSHOW_SUCCESS; }
[[gnu::noinline]]
redshow_result_t redshow_flush_now_dummy(uint32_t cpu_thread) { return REDSHOW_SUCCESS; }
