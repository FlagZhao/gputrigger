...
void sanitizer_context_map_context_lock(CUcontext context, int32_t thread_id) {
  sanitizer_context_map_entry_t *entry = NULL;
...
void sanitizer_context_map_context_unlock(CUcontext context, int32_t thread_id) {
  sanitizer_context_map_entry_t *entry = NULL;
...
void sanitizer_context_map_delete(CUcontext context) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_insert(CUcontext context, CUstream stream) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_analysis_function_update(CUcontext context, CUfunction function) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_priority_stream_handle_update(CUcontext context, Sanitizer_StreamHandle priority_stream_handle) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_kernel_stream_handle_update(CUcontext context, Sanitizer_StreamHandle kernel_stream_handle) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_buffer_device_update(
    CUcontext context,
    gpu_patch_buffer_t *buffer_device) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_buffer_addr_read_device_update(
    CUcontext context,
    gpu_patch_buffer_t *buffer_addr_read_device) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_aux_addr_dict_device_update(
    CUcontext context,
    gpu_patch_aux_address_dict_t *aux_addr_dict_device) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_buffer_addr_write_device_update(
    CUcontext context,
    gpu_patch_buffer_t *buffer_addr_write_device) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_buffer_reset_update(
    CUcontext context,
    gpu_patch_buffer_t *buffer_reset) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_buffer_addr_read_reset_update(
    CUcontext context,
    gpu_patch_buffer_t *buffer_addr_read_reset) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_aux_addr_dict_reset_update(
    CUcontext context,
    gpu_patch_aux_address_dict_t *aux_addr_dict_reset) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_buffer_addr_write_reset_update(
    CUcontext context,
    gpu_patch_buffer_t *buffer_addr_write_reset) {
  spinlock_lock(&sanitizer_context_map_lock);
...
void sanitizer_context_map_stream_lock(
    CUcontext context,
    CUstream stream) {
  sanitizer_context_map_entry_t *entry = NULL;
...
void sanitizer_context_map_stream_unlock(
    CUcontext context,
    CUstream stream) {
  sanitizer_context_map_entry_t *entry = NULL;
